...
ifeq ($(CONFIG_DDR_U_BOOT),y)
U_BOOT_DDR = $(obj)u-boot-ddr.bin
else
...
ifeq ($(CONFIG_MEDIA_U_BOOT),y)
MEDIA_SPL = media_spl
U_BOOT_MEDIA = $(obj)u-boot-media.bin
endif
...
ALL += $(obj)u-boot.srec $(obj)u-boot.bin $(obj)System.map $(U_BOOT_NAND) $(U_BOOT_DDR) $(U_BOOT_MEDIA) $(U_BOOT_ONENAND) \
		$(obj)u-boot.disasm

all:		$(ALL)

$(obj)u-boot.disasm:	$(nandobj)u-boot
		$(OBJDUMP) -D $< > $@
...
$(MEDIA_SPL): $(TIMESTAMP_FILE) $(VERSION_FILE) $(obj)include/autoconf.mk
		$(MAKE) -C media_spl/board/amcc/serengeti all

$(U_BOOT_MEDIA): $(MEDIA_SPL) $(obj)u-boot.bin
		cat $(obj)u-boot.bin $(obj)media_spl/u-boot-media-spl.bin > $(obj)u-boot-media.bin

$(NAND_SPL):	$(TIMESTAMP_FILE) $(VERSION_FILE) $(obj)include/autoconf.mk
		$(MAKE) -C nand_spl/board/$(BOARDDIR) all

$(U_BOOT_NAND):	$(NAND_SPL) $(obj)u-boot.bin
		cat $(obj)nand_spl/u-boot-spl.bin $(obj)u-boot.bin > $(obj)u-boot-nand.bin; \
		rm $(obj)u-boot.bin

$(U_BOOT_DDR):	$(obj)u-boot.bin
		mv $(obj)u-boot.bin $(obj)u-boot-ddr.bin
...
meraki_config: unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/meraki
	@mkdir -p $(obj)nand_spl/board/amcc/serengeti
	@ln -fs serengeti $(obj)nand_spl/board/amcc/meraki
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_nand_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a meraki ppc ppc4xx meraki amcc
	@echo "TEXT_BASE = 0x01001000" > $(obj)board/amcc/meraki/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk

meraki_ddr_config: unconfig
	@echo "#define CONFIG_DDR_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_NAND_U_BOOT" >> $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_ddr_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a meraki ppc ppc4xx meraki amcc
	@echo "TEXT_BASE = 0x01001000" > $(obj)board/amcc/meraki/config.tmp
	@echo "CONFIG_DDR_U_BOOT = y" >> $(obj)include/config.mk

meraki_ocm_config: unconfig
	@mkdir -p $(obj)board/amcc/meraki
	@mkdir -p $(obj)include
	@echo "TEXT_BASE = 0xfffc0000" >> $(obj)board/amcc/meraki/config.tmp
	@echo "#define CONFIG_OCM_U_BOOT" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a meraki ppc ppc4xx meraki amcc
	@echo "LDSCRIPT:=$(SRCTREE)/board/amcc/meraki/u-boot-ocm.lds"\
		>> $(obj)board/amcc/meraki/config.tmp
	@echo "CONFIG_OCM_U_BOOT = y" >> $(obj)include/config.mk
...
serengeti_config: serengeti_rev11_config
serengeti_up_config: serengeti_rev11_up_config

serengeti_rev11_config: unconfig
	@mkdir -p $(obj)board/amcc/serengeti
	@mkdir -p $(obj)include
	@echo "#define CONFIG_HW_BRINGUP" >$(obj)include/config.h
	@echo "#define CONFIG_HW_REV_11" >>$(obj)include/config.h
	@echo "#define CONFIG_MP" >>$(obj)include/config.h
	@echo "TEXT_BASE = 0xfffa0000" > $(obj)board/amcc/serengeti/config.tmp
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc

serengeti_rev11_up_config: unconfig
	@mkdir -p $(obj)board/amcc/serengeti
	@mkdir -p $(obj)include
	@echo "#define CONFIG_HW_BRINGUP" >$(obj)include/config.h
	@echo "#define CONFIG_NOT_COHERENT_CACHE" >>$(obj)include/config.h
	@echo "#define CONFIG_HW_REV_11" >>$(obj)include/config.h
	@echo "TEXT_BASE = 0xfffa0000" > $(obj)board/amcc/serengeti/config.tmp
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc

serengeti_rev10_config: unconfig
	@mkdir -p $(obj)board/amcc/serengeti
	@mkdir -p $(obj)include
	@echo "#define CONFIG_HW_BRINGUP" >$(obj)include/config.h
	@echo "#define CONFIG_MP" >>$(obj)include/config.h
...
serengeti_rev10_up_config: unconfig
	@mkdir -p $(obj)board/amcc/serengeti
	@mkdir -p $(obj)include
	@echo "#define CONFIG_HW_BRINGUP" >$(obj)include/config.h
	@echo "#define CONFIG_NOT_COHERENT_CACHE" >>$(obj)include/config.h
...
serengeti_rev14_config: unconfig
	@mkdir -p $(obj)board/amcc/serengeti
	@mkdir -p $(obj)include
	@echo "#define CONFIG_HW_BRINGUP" >$(obj)include/config.h
	@echo "#define CONFIG_HW_REV_14" >>$(obj)include/config.h
	@echo "#define CONFIG_APM86XXX_DDR_AUTOCALIBRATION" >>$(obj)include/config.h
	@echo "#define CONFIG_MP" >>$(obj)include/config.h
	@echo "#define CONFIG_DDR_32BIT" >>$(obj)include/config.h
	@echo "#define CONFIG_FIXED_DDR_INIT" >>$(obj)include/config.h
	@echo "TEXT_BASE = 0xfffa0000" > $(obj)board/amcc/serengeti/config.tmp
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc

serengeti_amp_config: unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_AMP" >$(obj)include/config.h
	@echo "#define CONFIG_HW_BRINGUP" >>$(obj)include/config.h
	@echo "#define CONFIG_HW_REV_11" >>$(obj)include/config.h
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc

serengeti_pal_config: unconfig
	@mkdir -p $(obj)include
	@$(MKCONFIG) serengeti ppc ppc4xx serengeti amcc
	@echo "#include \"configs/palladium.h\"" >>$(obj)include/config.h

serengeti_nand_config: unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/serengeti
	@mkdir -p $(obj)nand_spl/board/amcc/serengeti
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_HW_BRINGUP" >>$(obj)include/config.h
	@echo "#define CONFIG_HW_REV_11" >>$(obj)include/config.h
	...
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_nand_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc
	@echo "TEXT_BASE = 0x01000000" > $(obj)board/amcc/serengeti/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk

serengeti_media_config: unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/serengeti
	@mkdir -p $(obj)media_spl/board/amcc/serengeti
	@echo "#define CONFIG_MEDIA_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_HW_BRINGUP" >> $(obj)include/config.h
	@echo "#define CONFIG_HW_REV_11" >>$(obj)include/config.h
	@echo "#define CONFIG_MP" >> $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_media_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc
	@echo "TEXT_BASE = 0x01000000" > $(obj)board/amcc/serengeti/config.tmp
	@echo "LDSCRIPT:=$(SRCTREE)/board/amcc/serengeti/u-boot-ddr.lds"\
		>> $(obj)board/amcc/serengeti/config.tmp
	@echo "CONFIG_MEDIA_U_BOOT = y" >> $(obj)include/config.mk

serengeti_ocm_config: unconfig
	@mkdir -p $(obj)board/amcc/serengeti
	@mkdir -p $(obj)include
	@echo "#define CONFIG_HW_BRINGUP" >$(obj)include/config.h
	@echo "#define CONFIG_HW_REV_11" >>$(obj)include/config.h
	@echo "#define CONFIG_MP" >>$(obj)include/config.h
	@echo "TEXT_BASE = 0xfffc0000" >> $(obj)board/amcc/serengeti/config.tmp
	@echo "#define CONFIG_OCM_U_BOOT" >> $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_rev11_ocm_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc
	@echo "LDSCRIPT:=$(SRCTREE)/board/amcc/serengeti/u-boot-ocm.lds"\
		>> $(obj)board/amcc/serengeti/config.tmp
	@echo "CONFIG_OCM_U_BOOT = y" >> $(obj)include/config.mk

mamba_wap_config: unconfig
	@mkdir -p $(obj)board/amcc/serengeti
	@mkdir -p $(obj)include
	@echo "#define CONFIG_HW_BRINGUP" >$(obj)include/config.h
	@echo "#define CONFIG_HW_REV_11" >>$(obj)include/config.h
	@echo "#define CONFIG_MP" >>$(obj)include/config.h
	@echo "#define CONFIG_MAMBA_WAP" >>$(obj)include/config.h
	@echo "#define CONFIG_FIXED_DDR_INIT	1" >>$(obj)include/config.h
	@echo "TEXT_BASE = 0xfffa0000" > $(obj)board/amcc/serengeti/config.tmp
	@$(MKCONFIG) -n $@ -a serengeti ppc ppc4xx serengeti amcc
...
clean:
	...
	@rm -f $(obj)nand_spl/board/*/*/stage-1/{u-boot-spl,*.map,*.disasm,*.bin*}
	@rm -f $(obj)nand_spl/board/*/*/stage-2/{u-boot-spl,*.map,*.disasm,*.bin*}
