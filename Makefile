...
U_BOOT_SRAM = $(obj)u-boot-sram.bin
endif
...
ALL += $(obj)u-boot.srec $(obj)u-boot.bin $(obj)System.map $(U_BOOT_NAND) $(U_BOOT_ONENAND) $(U_BOOT_SRAM)
...
$(U_BOOT_SRAM): $(obj)u-boot.bin
		cat $(obj)u-boot.bin > $(obj)u-boot-sram.bin
...
# Support for Beech validation board
beech_config:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_config=)) | \
		tr '[:lower:]' '[:upper:]')" >$(obj)include/config.h
	@$(MKCONFIG) -n $@ -a beech ppc ppc4xx beech amcc

beech_sram_config:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_config=)) | \
		tr '[:lower:]' '[:upper:]')" >$(obj)include/config.h
	@echo "#define CONFIG_SRAM_U_BOOT" >> $(obj)include/config.h
	@echo "TEXT_BASE = 0xE8000000" > $(obj)board/amcc/beech/config.tmp
	@echo "CONFIG_SRAM_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) -n $@ -a beech ppc ppc4xx beech amcc

beech_nand2kwoecc_config:	unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/beech
	@mkdir -p $(obj)nand_spl/board/amcc/beech
	@echo "#define CONFIG_NAND_U_BOOT" >> $(obj)include/config.h
	@echo "#define CONFIG_NAND2K_U_BOOT" >> $(obj)include/config.h
	@echo "#define CONFIG_BOOT_NAND_WO_ECC" >> $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_nand_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a beech ppc ppc4xx beech amcc
	@echo "TEXT_BASE = 0x01000000" > $(obj)board/amcc/beech/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_NAND2K_U_BOOT = y" >> $(obj)include/config.mk


beech_nand2k_config:	unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/beech
	@mkdir -p $(obj)nand_spl/board/amcc/beech
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_NAND2K_U_BOOT" >> $(obj)include/config.h
...
beech_nand4cycle_config:	unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/beech
	@mkdir -p $(obj)nand_spl/board/amcc/beech
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_NAND_4CYCLE_U_BOOT" >> $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_nand_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a beech ppc ppc4xx beech amcc
	@echo "TEXT_BASE = 0x01000000" > $(obj)board/amcc/beech/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_NAND_4CYCLE_U_BOOT = y" >> $(obj)include/config.mk

beech_nand4k_config:	unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/beech
	@mkdir -p $(obj)nand_spl/board/amcc/beech
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_nand_config=)) | \
	...
	@echo "TEXT_BASE = 0x01000000" > $(obj)board/amcc/beech/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_NAND4K_U_BOOT = y" >> $(obj)include/config.mk

# Support for BlueStone validation board
bluestone_config:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_config=)) | \
		tr '[:lower:]' '[:upper:]')" >$(obj)include/config.h
	@$(MKCONFIG) -n $@ -a bluestone ppc ppc4xx bluestone amcc

bluestone_sram_config:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_config=)) | \
		tr '[:lower:]' '[:upper:]')" >$(obj)include/config.h
	@echo "#define CONFIG_SRAM_U_BOOT" >> $(obj)include/config.h
	@echo "TEXT_BASE = 0xE8000000" > $(obj)board/amcc/bluestone/config.tmp
	@echo "CONFIG_SRAM_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) -n $@ -a bluestone ppc ppc4xx bluestone amcc

bluestone_nand2kwoecc_config:	unconfig
	@mkdir -p $(obj)include $(obj)board/amcc/bluestone
	@mkdir -p $(obj)nand_spl/board/amcc/bluestone
	@echo "#define CONFIG_NAND_U_BOOT" >> $(obj)include/config.h
	@echo "#define CONFIG_NAND2K_U_BOOT" >> $(obj)include/config.h
	@echo "#define CONFIG_BOOT_NAND_WO_ECC" >> $(obj)include/config.h
	@echo "#define CONFIG_$$(echo $(subst ,,$(@:_nand_config=)) | \
		tr '[:lower:]' '[:upper:]')" >> $(obj)include/config.h
	@$(MKCONFIG) -n $@ -a bluestone ppc ppc4xx bluestone amcc
	@echo "TEXT_BASE = 0x01000000" > $(obj)board/amcc/bluestone/config.tmp
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@echo "CONFIG_NAND2K_U_BOOT = y" >> $(obj)include/config.mk
