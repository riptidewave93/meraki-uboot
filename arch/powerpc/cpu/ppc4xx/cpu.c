...
#define SDR0_PINSTP_SHIFT       29
static char *bootstrap_str[] = {
        "NAND w/ECC 2k page (8 bits)",
        "NAND w/ECC 2k page (8 bits)",
        "NAND w/ECC 2k page (8 bits)", /* need to verify */
        "NAND wo/ECC 2k page (8 bits)",
        "NOR/SRAM (8 bits)",
        "NOR/SRAM (8 bits) w/PLL Bypassed",
        "I2C (Addr 0x54)",      /* A8 */
        "I2C (Addr 0x52)",      /* A4 */
};
static char bootstrap_char[] = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H' };
...
#if defined(CONFIG_460EX) || defined(CONFIG_460GT)
	puts("60");
#elif defined(CONFIG_431EX) || defined(CONFIG_431EXR)
	puts("31");
...
#if defined(CONFIG_APM82181)
	case PVR_APM82181_RA:
		mfsdr(SDR0_ECID3, ecid);
		if (ecid & 0x00200000)
			puts("APM82161 Rev. A");
		else
			puts("APM82181 Rev. A");
...
#if defined(CONFIG_PCI) && !defined(CONFIG_405EX) && !defined(CONFIG_APM82181)
