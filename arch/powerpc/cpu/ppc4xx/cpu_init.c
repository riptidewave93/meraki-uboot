...
void reconfigure_pll(u32 new_cpu_freq)
{
	...
	/* By-pass PLL reconfig if using I2C EEPROM bootstrap */
	...
	if ((reg >> 29) >= 6)
        ...
        reg &= 0x80000000;
        if (reg == 0){
               if (new_cpu_freq == CONFIG_CLK_800_200_200_100) {
                        mtcpr(CPR0_PLLC, 0x40000341);
                        mtcpr(CPR0_PLLD, 0xd8010400);    /*800MHz*/
                        mtcpr(clk_cpud, 0x01000000);  /*800MHz*/
                        mtcpr(clk_plb2d, 0x04000000);
                        mtcpr(CPR0_OPBD, 0x02000000);    /*800MHz*/
                        mtcpr(CPR0_PERD, 0x01000000);
                        mtcpr(clk_ddr2d, 0x04000000);
                        mtcpr(clk_clkupd, 0x80000000);
                } else if (new_cpu_freq == CONFIG_CLK_1000_166_250_83) {
                        mtcpr(CPR0_PLLC, 0x40000342);
                        mtcpr(CPR0_PLLD, 0xDE010000);    /*1GHz*/
                        mtcpr(clk_cpud, 0x01000000);  /*1GHz*/
                        mtcpr(clk_plb2d, 0x06000000);
                        mtcpr(CPR0_OPBD, 0x02000000);    /*1GHz*/
                        mtcpr(CPR0_PERD, 0x01000000);
                        mtcpr(clk_ddr2d, 0x04000000);
                        mtcpr(clk_clkupd, 0x80000000);
                } else if (new_cpu_freq == CONFIG_CLK_1000_250_250_83) {
                		mtcpr(CPR0_PLLC, 0x40000342);
                        mtcpr(CPR0_PLLD, 0xDE010000);    /*1GHz*/
                        mtcpr(clk_cpud, 0x01000000);  /*1GHz*/
                        mtcpr(clk_plb2d, 0x04000000);
                        mtcpr(CPR0_OPBD, 0x03000000);    /*1GHz*/
                        mtcpr(CPR0_PERD, 0x01000000);
                        mtcpr(clk_ddr2d, 0x04000000);
                        mtcpr(clk_clkupd, 0x80000000);
                } else if (new_cpu_freq == CONFIG_CLK_1200_200_300_100) {
                        mtcpr(CPR0_PLLC, 0x40000340);
                        mtcpr(CPR0_PLLD, 0xBA000000);    /*1.2GHz*/
                        mtcpr(clk_cpud, 0x01000000);  /*1.2GHz*/
                        mtcpr(clk_plb2d, 0x06000000);
                        mtcpr(CPR0_OPBD, 0x02000000);    /*1.2GHz*/
                        mtcpr(CPR0_PERD, 0x01000000);
                        mtcpr(clk_ddr2d, 0x04000000);
                        mtcpr(clk_clkupd, 0x80000000);
                } else if (new_cpu_freq == CONFIG_CLK_1200_200_200_100) {
                        mtcpr(CPR0_PLLC, 0x40000340);
                        mtcpr(CPR0_PLLD, 0xBA000000);    /*1.2GHz*/
                        mtcpr(clk_cpud, 0x01000000);  /*1.2GHz*/
                        mtcpr(clk_plb2d, 0x06000000);
                        mtcpr(CPR0_OPBD, 0x02000000);    /*1.2GHz*/
                        mtcpr(CPR0_PERD, 0x01000000);
                        mtcpr(clk_ddr2d, 0x06000000);
                        mtcpr(clk_clkupd, 0x80000000);
                } else if (new_cpu_freq == CONFIG_CLK_667_166_166_83) {
                    	mtcpr(CPR0_PLLC, 0x40000341);
                    	mtcpr(CPR0_PLLD, 0xDE0F0000);    /*667MHz*/
                    	mtcpr(clk_cpud, 0x01000000);  /*667MHz*/
                    	mtcpr(clk_plb2d, 0x04000000);
                    	mtcpr(CPR0_OPBD, 0x02000000);    /*667MHz*/
                    	mtcpr(CPR0_PERD, 0x01000000);
                    	mtcpr(clk_ddr2d, 0x04000000);
                    	mtcpr(clk_clkupd, 0x80000000);
                } else {
                        return; /* no others supported */
                } 
                /* Set reload inhibit so configuration will persist across
                 * processor resets */
                mfcpr(CPR0_ICFG, reg);
                reg &= ~0x80000000; /* CPR0_ICFG_RLI_MASK */
                reg |= 1 << 31;
                mtcpr(CPR0_ICFG, reg);
...
cpu_init_f (void)
{
    ...
    defined(CONFIG_460EX) || defined(CONFIG_APM82181)
	u32 val;
#endif
	...
	!defined(CONFIG_SYS_4xx_GPIO_TABLE) && !defined(CONFIG_APM82181)
	/*
...
#if defined(CONFIG_APM82181)
	/*
	 * Set SDR0_AHB_CFG[OTG_PROT2] (bit 0), 
	 * set SDR0_AHB_CFG[A2P_INCR4] (bit 24) and
	 * clear SDR0_AHB_CFG[A2P_PROT2] (bit 25) 
         * This setting will avoid hanging system during
         * concurrently using USB and SATA.
	 */
...
#endif /* CONFIG_460EX || CONFIG_APM82181 */

#if defined(CONFIG_405EX) || \
    defined(CONFIG_440SP) || defined(CONFIG_440SPE) || \
    defined(CONFIG_460EX) || defined(CONFIG_460GT)  || \
    defined(CONFIG_460SX) || defined(CONFIG_APM82181)
	/*
