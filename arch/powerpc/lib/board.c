...
extern ulong __stext, __srodata, __sdata, __sbss;
...
#if defined(CONFIG_APM82181)
	/* Disable NDFC - Enable NOR access */
...
# endif
	...
	WATCHDOG_RESET ();
#if defined(CONFIG_APM82181)
	 /* Enable NDFC - FIXME: Only enable chip select 1 right now */
	mfsdr(SDR0_CUST0, sdr0_cust0);
        sdr0_cust0 = ((sdr0_cust0 | SDR_CUST0_NDFC_ENABLE) &
	...
	/* Disable NDFC - Go back to NOR FLASH */
        mfsdr(SDR0_CUST0, sdr0_cust0);
        sdr0_cust0 = (sdr0_cust0 & (~SDR_CUST0_NDFC_ENABLE)) &
			SDR_CUST0_NCG_EBC;
        mtsdr(SDR0_CUST0, sdr0_cust0);
...
/** leave this here (after malloc(), environment and PCI are working) **/
	...
	printf("For GDB: add-symbol-file u-boot "
	       "0x%08lx -s .rodata 0x%08lx -s .data 0x%08lx -s .bss 0x%08lx\n",
	       &__stext, &__srodata, &__sdata, &__sbss);
...
#endif
	check_reset_button();	//Alex:20101221
