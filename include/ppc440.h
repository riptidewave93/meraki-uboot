...
#define clk_clkupd	0x0020
#define clk_pllc        0x0040
#define clk_pllc_sel(pllc)	(((pllc) & 0x01000000) >> 24)
#define clk_plld        0x0060
#define clk_plld_fbdv(plld)	(((plld) & 0xff000000) >> 24)
#define clk_plld_fwdva(plld)	(((plld) & 0x000f0000) >> 16)
#define clk_cpud	0x0080
#define clk_cpud_cpudv(cpud)	(((cpud) & 0x07000000) >> 24)
#define clk_plb2d       0x00a0
#define clk_plb2d_plb2dv(plb2d)	(((plb2d) & 0x06000000) >> 25)
#define clk_opbd        0x00c0
#define clk_opbd_opbdv(opbd)	(((opbd) & 0x03000000) >> 24)
#define clk_perd        0x00e0
#define clk_perd_perdv(perd)	(((perd) & 0x03000000) >> 24)
#define clk_ddr2d       0x0100
#define clk_ddr2d_ddr2dv(ddr2d)	(((ddr2d) & 0x06000000) >> 25)
#define clk_icfg        0x0140
#endif
...
#define SDR0_DDR0_DDRM_DECODE(n)	((((unsigned long)(n))>>29)&0x03)
#define SDR0_DDR0_TUNE_ENCODE(n)	((((unsigned long)(n))&0x2FF)<<0)
#define SDR0_DDR0_TUNE_DECODE(n)	((((unsigned long)(n))>>0x2FF)
...
/* Duc: Temporary code */
#if defined(CONFIG_APM82181) /* Maui register */ 
/* Pin Function Control Register 0 (SDR0_PFC0) */
#define SDR0_PFC0		0x4100
#define SDR0_PFC0_GPIO_OUT_EN(x)	(1 >> (x))
#define SDR0_PFC0_GPIO_OUT_DIS(x)	(~(1 >> (x)))

/* Pin Function Control Register 1 (SDR0_PFC1) */
#define SDR0_PFC1		0x4101
#define SDR0_PFC1_TRACE_EN	0x80000000	/* Trace Mode Enable */
#define SDR0_PFC1_CPU_TRACE	0x00000000	/* CPU trace mode */
#define SDR0_PFC1_BUS_TRACE	0x40000000	/* BUS trace mode */
#define SDR0_PFC1_BPSEL0	0x20000000	/* Boot pin sellect 0 */
#define SDR0_PFC1_BPSEL1	0x10000000	/* Boot pin sellect 1 */
#define SDR0_PFC1_HSSCKEN	0x04000000	/* HSS Clock enable */
#define SDR0_PFC1_HSSCK_PE_TCLK	0x00000000	/* PE/SATA0 L0 TCLK */
#define SDR0_PFC1_HSSCK_PE_RCLK	0x0100000	/* PE/SATA0 L0 TCLK */
#define SDR0_PFC1_HSSCK_SATA1_TCLK	0x0200000	/* PE/SATA0 L0 TCLK */
#define SDR0_PFC1_HSSCK_SATA1_RCLK	0x0300000	/* PE/SATA0 L0 TCLK */
#define SDR0_PFC1_U0IM_2PINS	0x00000000	/* UART0 Interface Mode 2 pins*/
#define SDR0_PFC1_U0IM_4PINS	0x00040000	/* UART0 Interface Mode 4 pins*/

/* Bootstrap register */
#define SDR_PINSTP_SHIFT	29
#define SDR_PINSTP_MASK_A	0
#define SDR_PINSTP_MASK_B	1
#define SDR_PINSTP_MASK_C	2
#define SDR_PINSTP_MASK_D	3
#define SDR_PINSTP_MASK_E	4
#define SDR_PINSTP_MASK_F	5
#define SDR_PINSTP_MASK_G	6
#define SDR_PINSTP_MASK_H	7
...
#define SDR0_CUST0	0x4000
#define SDR_CUST0_NDFC_BOOT_DBG	0x80000000
#define SDR_CUST0_NDFC_BOOT_EBC	0x40000000
#define SDR_CUST0_NDFC_ENABLE	0x20000000
#define SDR_CUST0_NDFC_BW_MASK	0x10000000
#define SDR_CUST0_NDFC_BW_8_BIT	0x00000000
#define SDR_CUST0_NCG(x)	(0x80000000 >> (28 + (x)))
#define SDR_CUST0_NCG_EBC	(0xFFFFFFF0)

/* CPU priority in PLB bus */
#define SDR0_CP464		0x180
...
#define SDR0_ETH_CFG            0x4103
#define SDR0_ETH_CFG_TAHOE0_BYPASS      0x00001000      /* TAHOE0 Bypass selector */
#define SDR0_ETH_CFG_PHY_REFCLK_EN	0x80000000      /* EMAC0 PHY clock from PHY */
#define SDR0_ETH_CFG_PHY_CLK_SEL_PHY	0x00000000      /* EMAC0 PHY clock from PHY */
#define SDR0_ETH_CFG_PHY_CLK_SEL_LOOP	0x00001000      /* EMAC0 PHY clock from internal LOOP clock */
#define SDR0_ETH_CFG_MDIO_SEL		0x00000030      /* Select EMAC0 */
#define SDR0_ETH_CFG_GMC0_BRIDGE_SEL	0x00000001      /* Select RGMII0 */

#define SDR0_ETH_PLL		0x4200
...
#define SDR_USBOTG_PHY_BASE				0x03F0
#define SDR_USBOTG_PHY_CLKRST_OFFSET		0x0			/* Clock and Reset control register */
#define SDR_USBOTG_PHY_TUNE_OFFSET		0x1				/* Tuning control register */
#endif
...
/* Specific for Maui */
#define PLLSYS0_FWD_DIV_A_MASK  0x000000f0      /* Fwd Div A */
#define PLLSYS0_FWD_DIV_A_SHIFT	4
#define PLLSYS0_FB_DIV_MASK     0x0000ff00      /* Feedback divisor */
#define PLLSYS0_FB_DIV_SHIFT	8
#define PLLSYS0_OPB_DIV_MASK    0x03000000      /* OPB Divisor */
#define PLLSYS0_OPB_DIV_SHIFT	24
#define PLLSYS0_PLB2_DIV_MASK 	0x0c000000     /* PLB2 Clock Divisor */
#define PLLSYS0_PLB2_DIV_SHIFT	26
#define PLLSYS0_PERCLK_DIV_MASK 0x00c00000      /* Peripheral Clk Divisor */
#define PLLSYS0_PERCLK_DIV_SHIFT	22	
#define PLLSYS0_CPUCLK_DIV_MASK	0x70000000	/* CPU clock divisor */
#define PLLSYS0_CPUCLK_DIV_SHIFT	28
#define PLLSYS0_DDR2_DIV_MASK	0x00300000	/* DDR clock divisor */
#define PLLSYS0_DDR2_DIV_SHIFT	20
#define PLLSYS0_SEL_MASK        0x10000000      /* 0 = PLL, 1 = PerClk */
#define PLLSYS0_SEL_SHIFT	28
