...
int miiphy_read(const char *devname, unsigned int addr, unsigned int reg,
		 unsigned short *value);
int miiphy_write(const char *devname, unsigned int addr, unsigned int reg,
		  unsigned short value);
...
void miiphy_register(const char *devname,
		      int (*read)(const char *devname, unsigned int addr,
				   unsigned int reg, unsigned short *value),
		      int (*write)(const char *devname, unsigned int addr,
				    unsigned int reg, unsigned short value));
