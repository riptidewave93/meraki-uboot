...
//#endif
//#ifdef  CONFIG_K31
#if     defined(CONFIG_K31)||(FLASH_SIZE == 16)
...
#if (FLASH_SIZE == 16)
#define MTDPARTS_DEFAULT    "mtdparts=ar7240-nor0:256k(u-boot),256k(u-boot-env),5120k(rootfs),1024k(uImage),256k(NVRAM),9472k(ART)"
#else
