...
// SATA Device Control Register
#define SDR_SATA0_BIST		0x0400	/* SATA0 BIST Register */
#define SDR_SATA0_BISTSTS	0x0401	/* SATA0 BIST Status Register */
#define SDR_SATA0_CDRCTL	0x0402	/* SATA0 CDR Control Register */
#define SDR_SATA0_DRV		0x0403	/* SATA0 Drive Register */
#define SDR_SATA0_REC		0x0404	/* SATA0 Receiver Register */
#define SDR_SATA0_LPBK		0x0405	/* SATA0 Loopback Register */
#define SDR_SATA0_CLK		0x0406	/* SATA0 Clocking Register */
#define SDR_SATA0_RSTSTA	0x0408	/* SATA0 Reset Status Register */
#define SDR_SATA0_OBS		0x0409	/* SATA0 Observation Register */

#define SDR_SATA1_BIST		0x0410	/* SATA1 BIST Register */
#define SDR_SATA1_BISTSTS	0x0411	/* SATA1 BIST Status Register */
#define SDR_SATA1_CDRCTL	0x0412	/* SATA1 CDR Control Register */
#define SDR_SATA1_DRV		0x0413	/* SATA1 Drive Register */
#define SDR_SATA1_REC		0x0414	/* SATA1 Receiver Register */
#define SDR_SATA1_LPBK		0x0415	/* SATA1 Loopback Register */
#define SDR_SATA1_CLK		0x0416	/* SATA1 Clocking Register */
#define SDR_SATA1_RSTSTA	0x0418	/* SATA1 Reset Status Register */
#define SDR_SATA1_OBS		0x0419	/* SATA1 Observation Register */
