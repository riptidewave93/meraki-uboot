...
#else /* CONFIG_405EX || CONFIG_APM82181 */
/*
 * XXX - ToDo:
...
/*
 *  Memory Clock Phase select
 */
#if defined(CONFIG_460SX)
#define SDR0_MEMCLK_SEL 0x4401
#define MEMCLK_SEL_PHSEL_MASK   0x03800000
#define MEMCLK_SEL_180DEG_OFF   (0x0 << 23)
#define MEMCLK_SEL_270DEG_OFF   (0x5 << 23)
#define MEMCLK_SEL_90DEG_OFF    (0x6 << 23)
#endif
...
#define SDRAM_MCOPT1_DMWD_16		0x01000000 /* 16 bits			*/
...
#if defined(CONFIG_460SX)
#define SDRAM_SDTR3_RFC_MASK            0x000000FF
#define SDRAM_SDTR3_RFC_ENCODE(n)       ((((unsigned long)(n))&0xFF)<<0)
#else
...
#define SDRAM_FCSR_CMOS_MASK            0x00000030      /* Calibration Missed Oversample */
#define SDRAM_FCSR_CMOS_HIT             0x00000000      /* Hit Oversample                */
#define SDRAM_FCSR_CMOS_MISSED          0x00000010      /* Missed Oversample */
...
#define SDRAM_RTSR_RMOS                 0x00000080      /* Runtime missed oversample    */
#define SDRAM_RTSR_RHOS                 0x00000040      /* Runtime hit oversample       */
