...
int board_early_init_f(void)
{
	...
	// enable GPIO control for Topaz's LEDs
	setbits_be32(&gur->pmuxcr, 0x740000);
	setbits_be32(&gur->pmuxcr2, 0x000a8000);

	setbits_be32(&pgpio->gpdir, 0x210);
	mdelay(100);
	setbits_be32(&pgpio->gpdat, 0x210);
...
int board_early_init_r(void)
{
	...
	disable_tlb(flash_esel + 1);

	set_tlb(1, flashbase, CONFIG_SYS_FLASH_BASE_PHYS,
   			MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
   			0, flash_esel, BOOKE_PAGESZ_16M, 1);
 	set_tlb(1, flashbase+0x1000000, CONFIG_SYS_FLASH_BASE_PHYS+0x1000000,
   			MAS3_SX|MAS3_SW|MAS3_SR, MAS2_I|MAS2_G,
