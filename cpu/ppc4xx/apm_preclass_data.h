...
#define END_DB_INDEX		1023
#define MAX_DB_ENTRIES		1024
#define DB_ENTRY_SIZE		192
...
struct ptree_dn {
	...
	u8 chain_compare;	/**< 1b: Enable chained comparison	*/
