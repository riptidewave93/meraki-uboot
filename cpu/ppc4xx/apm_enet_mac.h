...
#define PHY_ADDR		0xFF/*1*/
#define PHY_ADDR1		0xFF/*2*/
#define READ_CMD		0
#define WRITE_CMD		1
#define MAX_CMD			2
...
#define BLOCK_ETH_MAC_NUM(x)		((u32)x * 0x30)
 ...
 **
 */
int apm_gmac_init(struct apm_data_priv *priv, unsigned char *dev_addr, int speed);
...
/**
 * @brief   This function sets the speed of GMAC
 * @param   priv MAC private stucture
 * @param   speed PHY Speed to be set on GMAC
 * @param   mac_addr ENET MAC Addresss required for gmac_init
 * @return  0 - success or -1 - failure
 **
 */
