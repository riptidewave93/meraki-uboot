...
static int ag7240_check_link(ag7240_mac_t *);
...
//    printf("ag7240_send length=0x%x \n",length);
    f->pkt_size = length;
    f->res1 = 0;
...
static int ag7240_recv(struct eth_device *dev)
{
    ...
    for (;;) {
        ...
        length = f->pkt_size;
//        printf("ag7240_recv length=0x%x \n",length);
...
//                 printf("(mac->mac_unit == 0 && is_ar7242())\n");
                 mgmt_cfg_val = 0x6;
            ...
            printf("Virian External MII mode MDC CFG Value ==> %x\n",mgmt_cfg_val);
#else
            /* Virian */
            mgmt_cfg_val = 0x4;
    ...
    if ( mac->mac_unit == 0 ) ag7240_check_link(mac);
...
static int ag7240_check_link(ag7240_mac_t *mac)
{
    ...
    {
       case _1000BASET:
//           printf("ag7240_check_link _1000BASET\n");
...
//               ar7240_reg_wr(AR7242_ETH_XMII_CONFIG,0x1c000000);
       ...
       case _100BASET:
//           printf("ag7240_check_link _100BASET\n");
       ...
       case _10BASET:
//           printf("ag7240_check_link _10BASET\n");
           ag7240_set_mac_if(mac, 0);
...
//    printf("ag7240_enet_initialize...eth%x\n",i);
    ...
    if ((is_ar7241() || is_ar7242())) 
//        printf("ag7240_enet_initialize...(is_ar7241() || is_ar7242())\n");
...
//    printf("ag7240_enet_initialize...ag7240_hw_start(ag7240_macs[%d]);\n",i);
    ag7240_hw_start(ag7240_macs[i]);
//    printf("ag7240_enet_initialize...ag7240_setup_fifos(ag7240_macs[%d]);\n",i);
...
//    printf("%s ag7240_phy_setup(ag7240_macs[%d]->mac_unit);\n",dev[i]->name,i);
