...
out_unreg:
	...
	ubi_err("'%s' cannot initialize UBI %s, error %d", __FUNCTION__, ubi->ubi_name, err);
	return err;
}
...
int ubi_attach_mtd_dev(struct mtd_info *mtd, int ubi_num, int vid_hdr_offset)
{
	...
	if (err) {
		printf("failed to attach by scanning, error %d\n", err);
		goto out_free;
	}
