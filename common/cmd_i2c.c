 ...
 */
// WNC Steve 2013/08/27
static int __do_i2c_md ( cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
// WNC
{
	u_char	chip;
...
// WNC Steve 2013/08/27
			...
			for (j=0; j<linebytes*(i2cWord?2:1); j++) {
// WNC
				printf(" %02x", *cp++);
				addr++;
			}
...
static int do_i2c_md ( cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    i2cWord = 0;
    i2cByte = 0;
    return __do_i2c_md (cmdtp, flag, argc, argv);
}
// WNC
 ...
 */
// WNC Steve 2013/08/27
static int __do_i2c_mw ( cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
// WNC
{
	uchar	chip;
	ulong	addr;
...
// WNC
	...
	while (count-- > 0) {
// WNC Steve 2013/08/07
		//if (i2c_write(chip, addr++, alen, &byte, 1 /*WNC.Steve: 1 is  hardcode by BRCM?*/) != 0)
		if (i2c_write(chip, addr++, alen, &val, 1 /*WNC.Steve: 1 is  hardcode by BRCM?*/) != 0)
// WNC
...
{
    return __do_i2c_mw (cmdtp, flag, argc, argv);
}
// WNC

// WNC Steve 2013/08/23
static int do_i2c_mdb ( cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    i2cByte = 1;
    i2cWord = 0;
    return __do_i2c_md(cmdtp, flag, argc, argv);
...
static int do_i2c_mwb ( cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    i2cByte = 1;
    i2cWord = 0;
    return __do_i2c_mw(cmdtp, flag, argc, argv);
}
static int do_i2c_mdw ( cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    i2cByte = 0;
    i2cWord = 1;
    return __do_i2c_md(cmdtp, flag, argc, argv);
...
static int do_i2c_mww ( cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    i2cByte = 0;
    i2cWord = 1;
    return __do_i2c_mw(cmdtp, flag, argc, argv);
...
// WNC Steve 2013/08/23
    U_BOOT_CMD_MKENT(mdb, 3, 1, do_i2c_mdb, "", ""),
    U_BOOT_CMD_MKENT(mwb, 3, 1, do_i2c_mwb, "", ""),
    U_BOOT_CMD_MKENT(mdw, 3, 1, do_i2c_mdw, "", ""),
    U_BOOT_CMD_MKENT(mww, 3, 1, do_i2c_mww, "", ""),
// WNC
